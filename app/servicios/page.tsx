...
/* ─── Boot sequence ─── */
const bootLines = [
  { text: "> LOADING ARSENAL...", delay: 0 },
  { text: "> PRØTØCØL ENGINE: ØNLINE", delay: 300 },
  { text: "> 3 PHASES DETECTED. READY_", delay: 600 },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {caseMetrics.map((c) => (
                ...
                >
                  ...
                  <p className="text-sm text-accent-cold">{c.highlight}</p>
        ...
        <Container>
          <div className="max-w-2xl mx-auto text-center space-y-8">
            <h2 className="text-[1.5rem] md:text-[2.25rem] leading-[1.2] terminal-glow">
              ¿Listø para reducir tu Re?
            </h2>
            <p className="text-text-secondary">
              Cønsulta inicial gratuita. Sin cømprømisø. Analizamøs tu
              situación y recømendamøs la fase adecuada.
            </p>
